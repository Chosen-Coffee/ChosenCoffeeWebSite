      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto space-y-6 opacity-0 animate-fade-up">
            <span className="inline-block px-5 py-2 rounded-full bg-secondary/30 backdrop-blur-sm font-dancing text-xl text-primary-foreground">
              Bienvenidos
            </span>

            <h1 className="font-dancing text-4xl md:text-6xl font-bold text-primary-foreground leading-tight">
              Chosen Coffee
            </h1>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
            {features.map((feature, index) => (
              <div
                key={feature.title}
                className={`menu-card text-center p-6 md:p-8 opacity-0 animate-fade-up stagger-${index + 2}`}
              >
